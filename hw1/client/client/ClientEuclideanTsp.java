...
import a.client.Client;
import a.tasks.EuclideanTspTask;
...
public class ClientEuclideanTsp extends Client<List<Integer>>
{
    ...
    {
        super( "Euclidean TSP", "localhost", new EuclideanTspTask( CITIES ) );
    }

    /**
     * Run the EuclideanTsp visualizer client
     * @param args unused
    ...
    /**
     * Get function for JLabel of our tour representation.
     * @param tour Specify which JLabel to grab
     * @return JLabel
     */
    ...
    /**
     * tourToString
     * @param cities Data representation of our tour.
     * @return Returns our tour in string representation.
     */
